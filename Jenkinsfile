pipeline {
    ...
    stages {
        ...
        stage('Install dependencies') {
            steps {
                sh 'echo "deb http://archive.debian.org/debian/ stretch main contrib non-free" | su-exec tee /etc/apt/sources.list'
                sh 'echo "deb http://archive.debian.org/debian/ stretch-proposed-updates main contrib non-free" | su-exec tee -a /etc/apt/sources.list'
                sh 'echo "deb http://archive.debian.org/debian-security stretch/updates main contrib non-free" | su-exec tee -a /etc/apt/sources.list'
